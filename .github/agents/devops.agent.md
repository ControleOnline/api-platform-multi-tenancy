---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-multi-tenancy, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-multi-tenancy`.
...
- Checkout local: `api-community/modules/controleonline/multi-tenancy`
